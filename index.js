//defining node_modules to be used in the app
...
// defining middlewares to be used in the app
const appErrorHandler = require('./app/middleware/appError');
const routeIpLogger = require('./app/middleware/routeIpLogger');

// defining libraries to be used in the app
